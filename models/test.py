...
model = VivitForVideoClassification.from_pretrained("/home/emir/Desktop/dev/VVAP/models/model_output_1/checkpoint-13800").to("cuda")
image_processor = VivitImageProcessor(do_resize=False, crop_size=64, do_normalize=False, offset=False, do_center_crop=False)
correct = 0
df = pd.read_csv("/home/emir/Desktop/dev/datasets/ETF_Video_Test/dataset.csv")
...
for i in range(len(df)):
    ...
    inputs = image_processor(np.array(video), return_tensors="pt").to("cuda")
